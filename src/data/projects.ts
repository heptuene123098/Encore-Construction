...
export const projects: Project[] = [
  {
    ...
    units: 25,
    availableUnits: 2,
    priceRange: "₦900,000,000 - ₦1,200,000,000",
  ...
  },
  {
    ...
    image: project5,
    units: 20,
    priceRange: "₦150,000 - ₦300,000,000",
  ...
  },
  {
    ...
    description: "Exclusive 4-floor boutique terrace.",
    floors: 4,
...
export const apartments: Apartment[] = [
  { id: "apt-1", projectId: "M6M", projectName: "MAISON 6", name: "Unit F2 - Sky Suite", bedrooms: 4, bathrooms: 4, area: 107629, floor: 4, price: 1200000, image: project2, available: true, amenities: ["Balcony", "City View", "Walk-in Closet"] },
  { id: "apt-2", projectId: "M6M", projectName: "MAISON 6", name: "Unit 30B - Penthouse", bedrooms: 4, bathrooms: 3, area: 107629, floor: 30, price: 1150000, image: project2, available: true, amenities: ["Terrace", "Private Pool", "Double Height Ceiling"] },
  { id: "apt-3", projectId: "MOM", projectName: "THE ROCK APARTMENT", name: "Unit 8C - Marina View", bedrooms: 2, bathrooms: 2, area: 21312, floor: 8, price: 480000, image: project4, available: true, amenities: ["Ocean View", "Smart Home", "Parking"] },
  { id: "apt-4", projectId: "MOM", projectName: "THE ROCK APARTMENT", name: "Unit 45A - Royal Suite", bedrooms: 5, bathrooms: 4, area: 21312, floor: 45, price: 1750000, image: project4, available: true, amenities: ["Full Floor", "Butler Service", "Helipad Access"] },
  { id: "apt-5", projectId: "RAG", projectName: "THE ROCK APARTMENT", name: "Unit 5D - Garden Studio", bedrooms: 1, bathrooms: 1, area: 21528, floor: 5, price: 285000, image: project3, available: true, amenities: ["Garden Terrace", "EV Charging", "Yoga Access"] },
  { id: "apt-6", projectId: "RAG", projectName: "THE ROCK APARTMENT", name: "Unit 22A - Family Suite", bedrooms: 3, bathrooms: 2, area: 21528, floor: 22, price: 680000, image: project3, available: true, amenities: ["Vertical Garden", "Co-working Access", "Kids Area"] },
  { id: "apt-7", projectId: "GPI", projectName: "THE GOOD PLACE", name: "Unit 55A - Ultra Lux", bedrooms: 4, bathrooms: 4, area: 21528, floor: 20, price: 680000, image: project1, available: true, amenities: ["City View", "Home Office", "Concierge"] },
  { id: "apt-8", projectId: "GPI", projectName: "THE GOOD PLACE", name: "Unit 20B - Executive", bedrooms: 2, bathrooms: 2, area: 21528, floor: 20, price: 680000, image: project1, available: true, amenities: ["City View", "Home Office", "Concierge"] },
  { id: "apt-9", projectId: "GPL", projectName: "THE GOOD PLACE", name: "Unit 15C - Smart Suite", bedrooms: 2, bathrooms: 1, area: 25833, floor: 15, price: 390000, image: project8, available: true, amenities: ["5G Enabled", "Smart Locks", "Pod Parking"] },
  { id: "apt-10", projectId: "GPL", projectName: "THE GOOD PLACE", name: "Unit 38A - Sky Loft", bedrooms: 3, bathrooms: 2, area: 25833, floor: 38, price: 920000, image: project8, available: true, amenities: ["Duplex", "Drone Delivery", "AI Concierge"] },
];
